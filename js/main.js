...
function contruirPeli(peli){
        ...
        <div class="row g-0 align-items-center">
          ...
          <div class="col-md">
            <div class="card-body" style="display: flex;height: 300px; overflow: auto; flex-direction: column;">
              <p class="card-text">${peli.results.description}</p>
              <p class="card-text"><small class="text-body-light">Ver Trailer</small></p>
            </div>
          </div>
        </div>
    </div>`;
